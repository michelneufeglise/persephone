...
const FAMILIES: Record<string, ModelMeta> = {
  ...
  'qwen3.8': {
    ...
    strengths: ['Native thinking mode', 'Long-context retrieval', 'Strong reasoning + tool use'],
    bestFor: 'Complex multi-step reasoning and agentic tool use on capable hardware.',
    tagline: 'Latest-gen Qwen with native thinking.',
  },
  'qwen3.6': {
    family: 'qwen3.6',
